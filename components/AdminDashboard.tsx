...
import { UsersIcon, UserGroupIcon, ShoppingBagIcon, WrenchScrewdriverIcon, DashboardIcon, ArrowLeftOnRectangleIcon, BoltIcon, StarIcon } from './Icons';
...
type Page = 'dashboard' | 'electricians' | 'products' | 'services' | 'clients';
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <aside className="w-64 bg-eletri-blue-900 text-white flex flex-col p-4 fixed h-full">
                ...
                <div className="mt-auto">
                    <button onClick={onLogout} className="w-full flex items-center justify-center gap-2 p-3 rounded-lg text-lg text-eletri-blue-100 hover:bg-eletri-blue-800 transition-colors">
